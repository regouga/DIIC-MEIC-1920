...
\subsubsection{A case study: the ambient orb}
...
\subsubsection{Peer pressure}
This idea, however, generates an incon


\subsection{Contributions}
Our main goal is to give users a better insight of how good or bad are their ecological behaviours. Our project makes the following contributions:
...
\begin{enumerate}
  ...
  \item Results of how the internet of things play a crucial role in the experience with technology that is very simple, useful, non evasive, that provide quick and reliable access
\end{enumerate}}
